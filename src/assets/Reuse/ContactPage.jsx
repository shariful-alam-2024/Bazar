...
const ContactPage = () => {
  return (
    <div className="bg-white min-h-screen py-12 px-4 sm:px-6 pt-24 dark:bg-gray-900 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-600">Uttara-1212,Dhaka-Bangladesh</p>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">
              Phone
            </h3>
            <p className="text-gray-600">+8801829197321</p>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-2">
              Email
            </h3>
            <p className="text-gray-600">sharifullinkdin2024@gmail.com</p>
